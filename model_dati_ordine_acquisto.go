...
// checks if the DatiOrdineAcquisto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatiOrdineAcquisto{}
...
type NullableDatiOrdineAcquisto struct {
	value *DatiOrdineAcquisto
	isSet bool
}

func (v NullableDatiOrdineAcquisto) Get() *DatiOrdineAcquisto {
	return v.value
}

func (v *NullableDatiOrdineAcquisto) Set(val *DatiOrdineAcquisto) {
	v.value = val
	v.isSet = true
}
...
func NewNullableDatiOrdineAcquisto(val *DatiOrdineAcquisto) *NullableDatiOrdineAcquisto {
	return &NullableDatiOrdineAcquisto{value: val, isSet: true}
}
