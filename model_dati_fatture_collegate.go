...
// checks if the DatiFattureCollegate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatiFattureCollegate{}
...
type NullableDatiFattureCollegate struct {
	value *DatiFattureCollegate
	isSet bool
}

func (v NullableDatiFattureCollegate) Get() *DatiFattureCollegate {
	return v.value
}

func (v *NullableDatiFattureCollegate) Set(val *DatiFattureCollegate) {
	v.value = val
	v.isSet = true
}

func (v NullableDatiFattureCollegate) IsSet() bool {
	return v.isSet
}
...
func NewNullableDatiFattureCollegate(val *DatiFattureCollegate) *NullableDatiFattureCollegate {
	return &NullableDatiFattureCollegate{value: val, isSet: true}
}
