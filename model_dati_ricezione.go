...
// checks if the DatiRicezione type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatiRicezione{}
...
func (v NullableDatiRicezione) Get() *DatiRicezione {
	return v.value
}
...
func NewNullableDatiRicezione(val *DatiRicezione) *NullableDatiRicezione {
	return &NullableDatiRicezione{value: val, isSet: true}
}
