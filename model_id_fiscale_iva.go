...
// checks if the IdFiscaleIVA type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdFiscaleIVA{}
...
func (v NullableIdFiscaleIVA) Get() *IdFiscaleIVA {
	return v.value
}
...
func NewNullableIdFiscaleIVA(val *IdFiscaleIVA) *NullableIdFiscaleIVA {
	return &NullableIdFiscaleIVA{value: val, isSet: true}
}
